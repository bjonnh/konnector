...
class OfficialGBIFAPI : GBIFAPI {
    ...
    override var retryDelay: Long = GBIF_DEFAULT_RETRY_DELAY
    override var delayTime: Long = GBIF_REQUEST_DELAY_TIME
    ...
    private fun updateDelayFromHeaderData(
        limit: String? = GBIF_DEFAULT_NUMBER_OF_QUERIES_BY_INTERVAL,
        interval: String? = GBIF_DEFAULT_INTERVAL
    ) {
